...
const App = () => {
  ...
  return (
    <div className='flex flex-col w-full relative main-container'>
      ...
      <div className='w-full h-screen bg-black flex flex-col items-center justify-center z-10 initial-video-section'>

        <div className='w-full h-42 relative text-center flex items-center justify-center'>
          ...
          <Marquee speed={120} className='w-full h-full z-8'>
            <h1 className='text-[9rem] z-8 text-[#f2f2f2] font-thin tracking-wider text-glow'>LWL8 - Series L2</h1>
          </Marquee>

        </div>
      </div>

      <div className='hero-section flex flex-col items-center justify-center w-full h-screen p-10 debug'>

        <div className='w-full h-full debug'>
